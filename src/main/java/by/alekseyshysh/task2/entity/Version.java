...
public class Version {
	...
	public Version(String distributionVersion, Certificate certificate, PackageEntity packageEntity,
			List<Dosage> dosages) {
	...
	public boolean equals(Object object) {
		...
		if (distributionVersion.equals(other.distributionVersion) && certificate.equals(other.certificate)
